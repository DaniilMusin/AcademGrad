...
// Оптимизированные inline SVG иконки
...
export default function Footer({ className = '' }: FooterProps) {
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setEmail('');
      alert('Спасибо за подписку! Мы будем присылать вам полезные материалы.');
    }, 1000);
  };

  const productLinks = [
    { name: 'Банк заданий ЕГЭ', href: '/', icon: BookOpen },
    { name: 'Аналитика прогресса', href: '/analytics', icon: TrendingUp },
    { name: 'ИИ-помощник', href: '/chat', icon: Zap },
    { name: 'Геймификация', href: '/achievements', icon: Award },
  ];
  ...
  const supportLinks = [
    ...
    { name: 'Обратная связь', href: '/feedback', icon: Mail },
  ];
  ...
  const subjects = [
    { name: 'Математика (профиль)', href: '/tasks/math' },
    { name: 'Физика', href: '/tasks/physics' },
    { name: 'Химия', href: '/tasks/chemistry' },
    { name: 'Информатика', href: '/tasks/informatics' },
  ];
  ...
  const stats = [
    { label: 'Активных учеников', value: '12,000+', icon: Users },
    { label: 'Решенных задач', value: '500,000+', icon: BookOpen },
    { label: 'Средний балл ЕГЭ', value: '85.4', icon: TrendingUp },
    { label: 'Процент поступления', value: '94%', icon: Award },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">твой ИИ-наставник</p>
              </div>
            </div>
            
            <p className="text-gray-400 mb-6 max-w-md">
              Современная платформа для подготовки к ЕГЭ с персональным ИИ-помощником. 
              Готовьтесь эффективно и достигайте высоких результатов.
            </p>
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Никакого спама. Только полезная информация о подготовке к ЕГЭ.
              </p>
            </div>
          ...
          <div>
            ...
            <h5 className="text-md font-semibold text-white mt-6 mb-3">Предметы</h5>
          ...
          <div>
            ...
            {/* Social Links */}
            <h5 className="text-md font-semibold text-white mt-6 mb-3">Мы в соцсетях</h5>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4 text-sm text-gray-400">
              <span>© 2024 AcademGrad. Все права защищены.</span>
              <span className="hidden md:inline">•</span>
              <span className="hidden md:inline">Лицензия № 123456</span>
            </div>
